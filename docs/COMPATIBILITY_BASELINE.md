...
- The same output jar compiles against all eight Vault profiles. Vault-facing
...
- Wolds Vaults 0.33.0 is compile-verified against Vault `3.21.6.6884` and JEI
  `10.2.1.1006` as a distinct packaging profile.
