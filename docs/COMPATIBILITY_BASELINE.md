...
| The Vault Remastered (VaultCrafters) | `20.0.3-remastered` | Read-only VaultCrafters instance | `95B8BA4932B11B02BD8E7CE5A201F8D561F95041F7431685BCB2E146D8005C9B` |
...
Remastered jar is now retained as a separate compile profile:

- Instance: `the_vault-1.18.2-20.0.3-remastered.jar`
- Local compile name:
  `the_vault-1.18.2-20.0.3-remastered.vaultcrafters.jar`
- SHA-256:
