...
@Pseudo
@Mixin(
        targets = "com.refinedmods.refinedstorage.setup.ClientSetup",
        remap = false
)
public abstract class RefinedStorageModelBakeMixin {
    @Redirect(
            method = "onModelBake",
            require = 0,
            at = @At(
    ...
    private static Set<ResourceLocation> vhaccelerator$refinedModels(
