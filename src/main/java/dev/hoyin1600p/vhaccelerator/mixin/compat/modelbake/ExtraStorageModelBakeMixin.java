...
@Pseudo
@Mixin(
        targets = "edivad.extrastorage.setup.ClientSetup",
        remap = false
)
public abstract class ExtraStorageModelBakeMixin {
    @Redirect(
            method = "onModelBake",
            require = 0,
            at = @At(
    ...
    private static Set<ResourceLocation> vhaccelerator$extraModels(
